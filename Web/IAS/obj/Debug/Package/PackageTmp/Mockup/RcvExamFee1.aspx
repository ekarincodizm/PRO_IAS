<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RcvExamFee1.aspx.cs" Inherits="IAS.Mockup.RcvExamFee1" %>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <br />
                            <br />
                            <asp:Button ID="btnDownload" runat="server" Text="ดาว์โหลด" Width="100px" />
                        </td>
                    </tr>
                </table>
                <table style="width: 100%;">
