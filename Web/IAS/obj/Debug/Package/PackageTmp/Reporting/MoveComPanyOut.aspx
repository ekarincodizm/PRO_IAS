<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site1.Master" AutoEventWireup="true"
    CodeBehind="MoveComPanyOut.aspx.cs" Inherits="IAS.Reporting.MoveComPanyOut" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function OpenPopup() {
            ...
            var qstr = "../Reporting/PopComPanyOut.aspx?startdate=" + startdate.value + "&enddate=" + enddate.value + "&licensetype=" + LicenseType_Select + "&comcode=" + compay_select + "&lincense_name=" + licenseType_name;
    ...
    <div class="box_content" align="center">
        <div class="box_content_header">
            <div class="box_content_header_text">
                รายงานการสถิติการย้ายออกบริษัท
            </div>
        </div>
