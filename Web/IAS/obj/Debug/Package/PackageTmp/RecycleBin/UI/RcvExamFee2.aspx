<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Home.Master" AutoEventWireup="true"
    CodeBehind="RcvExamFee2.aspx.cs" Inherits="IAS.UI.RcvExamFee2" %>
        ...
        <asp:Panel ID="PnlMain" runat="server" Visible="true" Width="100%">
            <div align="center">
                <table style="border: 3px solid black; width: 90%; text-align: center; vertical-align: middle;">
                    ...
                    <tr>
                        <td style="text-align: right; width: 20%;">
                            <asp:Label ID="lblPeople" runat="server" Text="จำนวนคน" CssClass="txt"></asp:Label>
                            <span>:</span>
                        </td>
                        <td style="text-align: left; width: 30%;">
                    ...
                    <tr>
                        <td style="text-align: right; width: 20%;">
                            <asp:Label ID="lblMoney" runat="server" Text="จำนวนเงิน" CssClass="lbl"></asp:Label>
                            <span>:</span>
                        </td>
                        <td style="text-align: left; width: 30%;">
                            <asp:TextBox ID="txtMoney" runat="server" CssClass="txt" Text="กรุณากรอกข้อมูล"
                                ForeColor="GrayText" onblur="WaterMark(this, event);"
                                onfocus="WaterMark(this, event);"></asp:TextBox>
                        </td>
                        <td>&nbsp;
