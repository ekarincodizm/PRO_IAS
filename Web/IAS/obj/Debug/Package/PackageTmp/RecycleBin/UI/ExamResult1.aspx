<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Home.Master" AutoEventWireup="true" CodeBehind="ExamResult1.aspx.cs" Inherits="IAS.UI.ExamResult1" %>
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="text-align: right; width: 20%;">
                        <asp:Label ID="lblFileName" runat="server" Text="ไฟล์ข้อมูล" CssClass="txt"></asp:Label>
                        <span>:</span>
                    </td>
