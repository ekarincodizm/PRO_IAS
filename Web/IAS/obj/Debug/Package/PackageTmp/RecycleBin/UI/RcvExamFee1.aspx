<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Home.Master" AutoEventWireup="true"
    CodeBehind="RcvExamFee1.aspx.cs" Inherits="IAS.UI.RcvExamFee1" %>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="text-align: center;">
                        <asp:Button ID="btnPrint" runat="server" Text="พิมพ์" CssClass="btn" />
                        <br />
                        <br />
                        <asp:Button ID="btnDownload" runat="server" Text="ดาว์โหลด" CssClass="btn" />
                    </td>
                </tr>
            </table>
            <table style="width: 100%;">
