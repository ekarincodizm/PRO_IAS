<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPerson.master" AutoEventWireup="true" CodeBehind="PersonCompany.aspx.cs" Inherits="IAS.Person.PersonCompany" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Detail" runat="server">
    ...
    <div class="box_content_header_text">
        <asp:Label   BorderStyle="None" Text="ลงทะเบียน (บริษัท)" ID="lblRegister"  runat="server" />
    </div>
    </div>
            ...
            <ContentTemplate>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 30%;">
                           <%--     <asp:TextBox ID="txtCompanyTel" runat="server" Width="230px" CssClass="txt" MaxLength="15"></asp:TextBox>--%>
                                <asp:TextBox ID="txtCompanyTel" runat="server" CssClass="txt-tel" MaxLength="9" onkeypress="fncInputNumericValuesOnly()"></asp:TextBox>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" CssClass="failureNotification" ValidationGroup="CompanyValidationGroup" 
                                    ErrorMessage="รูปแบบเบอร์โทรศัพท์หน่วยงานไม่ถูกต้อง" ControlToValidate="txtCompanyTel" ValidationExpression="^0[0-9]{8}" ><asp:Label ID="Label4" runat="server" visible="false">*</asp:Label>
