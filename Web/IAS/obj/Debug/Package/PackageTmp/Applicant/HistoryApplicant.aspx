<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site1.Master" AutoEventWireup="true" CodeBehind="HistoryApplicant.aspx.cs" Inherits="IAS.Applicant.HistoryApplicant" %>
                                        ...
                                        <table style="width:100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:left;">
                                                    ...
                                                    <asp:ListItem Text="รอการพิจารณา(สมาคม)" Value="000"></asp:ListItem>
                                                    <asp:ListItem Text="รอการพิจารณา(คปภ.)" Value="110"></asp:ListItem>
                                                    <asp:ListItem Text="อนุมัติ(คปภ.)" Value="211"></asp:ListItem>
                                                    <asp:ListItem Text="ไม่อนุมัติ(สมาคม)" Value="120"></asp:ListItem>
                                                    ...
                                                    <asp:GridView ID="gvDetail" runat="server" GridLines="None" Width="100%" CssClass="datatable"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="สมาคมที่พิจารณา" Visible="true" ItemStyle-HorizontalAlign="Center">
                                                                <ItemStyle Width="15%" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblExamPlaceName" runat="server" Text='<%# Bind("association_name") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="oic_result" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                                <ItemStyle Width="10%" CssClass="td-center" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbloicresult" runat="server" Text='<%# Bind("OIC_RESULT") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="association_result" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                                <ItemStyle Width="10%" CssClass="td-center" />
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblAssociationResult" runat="server" Text='<%# Bind("ASSOCIATION_RESULT") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                    ...
                                    <table style="width:100%;">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblOLdIDCardVisibleF" runat="server" CssClass="lbl" Visible="false"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">
